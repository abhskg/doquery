...
class Settings(BaseSettings):
    ...
    LOCAL_MODEL_SERVER_URL: str = os.getenv(
    ...
    )  # HF model ID for local use
    LOCAL_COMPLETION_MODEL: str = os.getenv(
    ...
    HUGGINGFACE_COMPLETION_MODEL: str = os.getenv(
    ...
    )  # OpenAI default, may change with other models
