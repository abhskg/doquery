...
def reset_database():
    ...
    try:
        ...
        with engine.connect() as conn:
            ...
            if 'id' in columns:
                logger.info("The 'id' column exists in the document table - schema is correct")
            else:
...
if __name__ == "__main__":
    ...
    confirm = input("This will DELETE ALL DATA in the database tables. Are you sure? (y/N): ")
    if confirm.lower() != 'y':
